...
namespace Todays_Crafts
{
    public partial class inventorycontrol : UserControl
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                cmd = new SqlCommand("DELETE FROM inventory WHERE id = '" + textBox1.Text + "'", con);
                cmd.ExecuteNonQuery();
